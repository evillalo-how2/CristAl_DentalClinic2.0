    ...
    <header className= "sticky top-0 z-40 border-b border-slate-200 bg-white/80 backdrop-blur dark:border-slate-800 dark:bg-slate-950/70">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
        ...
        <nav className="flex items-center gap-3" aria-label="Navegación principal">
          <a className="rounded-xl px-3 py-2 text-sm font-semibold text-slate-900 hover:bg-slate-100 dark:text-slate-100 dark:hover:bg-slate-900/60"href="#servicios">
            Servicios
          </a>
          <a className="rounded-xl px-3 py-2 text-sm font-semibold text-slate-900 hover:bg-slate-100 dark:text-slate-100 dark:hover:bg-slate-900/60" href="#por_que">
            ¿Por qué elegirnos?
          </a>
          <a
